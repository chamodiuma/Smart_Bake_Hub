                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 mb-10">
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="flex flex-col justify-center">
                                ...
                                <span className="text-[8px] font-semibold text-[#C8843B] uppercase tracking-widest mt-1.5 font-sans">WIJAYASIRI FRESH FOOD</span>
                            </div>
                        </div>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2 text-xs text-gray-300">
                            ...
                            <Link to="/menus" className="hover:text-[#C8843B] transition-colors w-fit">Our Menu</Link>
                            <Link to="/bookings" className="hover:text-[#C8843B] transition-colors w-fit">Event Booking</Link>
                    ...
                    <div className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-3 text-xs text-gray-300">
                            <div className="flex items-start gap-3">
                                ...
                                <span>No.288, Rathnapura Road, 12400 Horana, Sri Lanka</span>
                            </div>
                            <div className="flex items-center gap-3">
